...
class TestInvalidTickerFormats:
    ...
    def test_path_traversal_ticker(self):
    ...
    def test_script_injection_ticker(self):
    ...
    def test_ticker_with_semicolon(self):
...
class TestAnalyzeEndpoint:
    ...
    def test_analyze_with_auto_fetch_false_zero_metrics(self):
...
class TestWatchlistErrors:
    ...
    def test_watchlist_add_invalid_ticker_special_chars(self):
    ...
    def test_watchlist_add_ticker_too_long(self):
...
class TestPersonaEndpoint:
    ...
    def test_nonexistent_persona_returns_404(self):
...
class TestCustomPersonaErrors:
    ...
    def test_invalid_agent_id_uppercase_returns_400(self):
    ...
    def test_invalid_agent_id_with_spaces_returns_400(self):
